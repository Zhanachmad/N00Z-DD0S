...
def useragent():
    ...
    headers.append("Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/536.3 (KHTML, like Gecko) Chrome/19.0.1061.1 Safari/536.3")
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                count += 1
                print ("{0}\033[94mN0Z-DDoS "{}\033[33mATTACK Sent\033[0m".format(count))
